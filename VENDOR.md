...
cleanup below adds seven sites, and WP13 playtest round 2 (2026-09-15) adds the
40th: a per-TARGET non-combatant veto in `general_attack()`'s candidate filter.
