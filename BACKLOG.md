...
**Approved and in progress (2026-09-20).** The [execution plan](docs/research/round11-plan/README.md)
and [checkpoint](docs/research/round11-execution.md) track SPEC, GAME, WORLD-CAP,
AFF-GEAR, ART, COMBAT, FARM, REPAIR and SCOUT through independent review and the
next playtest. Rules are folded into living design before runtime work. The user
requires only minimal targeted LuaJIT gates/KATs and explicitly waives PUC runtime
tests this round; plain-5.1 syntax/static gates remain. No whole-WP shipped count
changes until acceptance. WP22 later material/profession repair redesign stays
open; its current round is the money-only trainer service defined in
...
| WP22 | Durability and repair: effect loss at zero durability, NPC repair for ledger money and tier-scaled costs; preserve the 3000/6000 combat-event budgets where applicable. Runtime-calibrate the WP29-authored dig-time/durability table (the B22 frame, `items_crafting.md` §3.0.4) and the usable-block targets for all six picks, including the fixed ×4/×6/×8/×10 under-tier destruction penalties. Do not derive speed or wear from the retired engine `leveldiff` coupling | open; specs: `items_crafting.md` mining/durability rules and `economy.md` repairs | WP5, WP7, WP43, WP44 |
...
| WP27 | Armor base recipes: register the twelve metal/cloth/leather shapes on the one shared equipment ladder; apply the decided T4–T6 G2 material rotation and cultural-visual metadata seams without creating parallel cultural catalogs. Every base recipe remains universally craftable; professions add refinement or special finishing | open; specs: `items_crafting.md` armor tables and `inventory_equipment.md` Round-10 EQUIP supplies universal base armor and ART its visuals; retain whole-WP acceptance and remaining dependencies separately. | WP26, WP43 |
...
| WP31 | Mounts: four riding tiers, persistent ownership and ephemeral controller/visual, damage dismount, geographic flight rules, capital-only trainers, first-person owner hiding, untimed status, nominal one-node land steps and mounted-attack refusal. WP44 later recalibrates the accepted interim prices. | in progress: independently clean GAME `b887124d`, CAP and ART are delivered on main, supplying the corrected mount runtime, six capital Riding stables/trainers and twelve rendered icons. Final integrated gates pass and main delivery is complete; GUI acceptance remains pending; this is not whole-WP completion. | WP28, WP40, WP44 |
| WP32 | Farming: all 17 crop families have seed, wet-soil growth, pause/resume and harvest/replant mechanics; MAP-B supplies world acquisition, secondary/field soils and sea/cave placement. Later active-claim integration retains the exhaustive ten-node growth audit. | in progress: independently reviewed FARM, ART and MAP-B are delivered on main. All seventeen families have wild/ingredient acquisition, seed conversion, legal-ground cultivation, wet/dry growth and current-save persistence evidence. Final integrated gates pass and main delivery is complete; GUI acceptance remains pending. Future Claim Stone integration belongs to WP24; ordinary farming has no Housing prerequisite. | WP10, WP24, WP33 |
...
- **WP41** still waits for WP5 and implements the exact §15 transaction;
  ...
  WP8/WP41, and **WP12** for WP17; WP40 no longer blocks these packages.
