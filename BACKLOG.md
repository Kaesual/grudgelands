...
| WP10 | Professions: six mains plus free Cooking; one six-tier recipe book per profession; level visibility and keystone unlocks. Recut Goldsmith around Quartz, Gold, the six G1/G2 gems, Rough→Cut processing, the fixed Setting ladder and both trinket slots; implement universal/cultural/PvP-special recipe ownership and direct cultural-master services. **R22:** the crafting inventory has a player recipe book listing every global recipe, while furnace cooking/smelting, the dual furnace and the VoxeLibre-style alchemy stand each have a station-specific book. No Gem Detector, Amplifier or Dowsing Rod exists. Retain Alchemist herbs/draughts, Leatherworker, Tailor, Woodcarver and Blacksmith scopes without parallel gear catalogs | open; design-side ready behind WP44 — A1/A3/A4/A5/E21 and R22 are decided. Round 7 shipped Food v2's six-tier data framework, current raw foods and T1 cooked dishes. Round 8 owns the real dish tables and recipes; WP10 still owns profession/recipe books and the later icon presentation; specs: `professions.md`, `items_crafting.md`, `inventory_equipment.md` | WP26 ✅, WP33 ✅, WP43 ✅, WP44 |
