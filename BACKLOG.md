...
1. **WP26 — universal bars/furnace**, **WP40 — named-zone map foundation**
   ...
   independently accepted. R6 contract preparation is next and is blocked by
   `TODO-design-wp40-r6-contract.md`. Read
