...
1. **WP13 — world structures**, selected by the user after WP40 completion.
   Begin with one start settlement; settle its brief and visual direction before
   implementation, then use a focused user playtest before broader rollout.
   Both WP40 and WP43 are shipped. This does not mark WP13 itself in progress
   or reduce its remaining six-race structures/civic-content scope.
