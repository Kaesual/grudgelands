...
| WP-Scout | Fourth class **Scout** (leather, bow + blade; **no stealth, no poison, no traps in v1** — user ruling 2026-09-16): design done (`docs/design/scout.md`), **three** implementation lanes (bow+arrows, leather+tanner, class+trees), uses **mana**. Depends on WP11's machinery and on the speed aggregator. Stealth is designed and deferred whole to `scout.md` §8 | open (spec: `docs/design/scout.md`) | WP11 |
