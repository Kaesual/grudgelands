...
| WP-HUD | Point-accurate LIFE bar and one MANA-or-RAGE bar above the hotbar, replacing the builtin heart statbars (user ruling 2026-09-16, "half hearts are an ugly approximation"). Also settles who owns the HUD offset stack, which four elements in three mods currently guess at | open (spec: `docs/research/hud-bars-task-card.md`) | WP4 |
| WP-Speed | **`grug_core` movement aggregator**: named modifiers with independent durations over **speed and jump**, root as a hard flag, mounts outside it — replacing the **three** `physics_override` writers measured in the tree (`grug_mobs/verbs.lua:153`, `grug_abilities/kits.lua:161-167`, and `grug_classes/selection.lua:52`/`:91`, which re-asserts a freeze and restores a snapshot). **~100 lines for the core plus the migration of each writer.** Prerequisite for WP11's Hold Ground, for the Scout's Sprint and for the mob-pressure patch; the mob-pressure lane owns it | open (spec: `docs/research/mob-pressure-task-card.md` §4b, `skill_trees.md` §3.9) | — |
...
### Readiness (updated 2026-09-13)

The backlog contains **46 stable work-package numbers, WP0–WP45**. Exactly
**19 are shipped**: WP0–WP4, WP6, WP7, WP15, WP18, WP19, WP25, WP33,
WP35, WP36, WP38, WP39, WP40, WP43 and WP45. WP16 is a canceled tombstone and is not shipped. Every
...
3. **WP37 — surface density**, **WP11 — skill trees**, **WP14 — offhand/carried
   light**, **WP20 — party**, **WP21 — recovery/rest** and **WP8 — quest
   framework** have shipped prerequisites.
...
- **WP5** is design-complete (A2/A6 decided 2026-08-13,
  ...
  2026-08-13) and now waits only on WP44; WP26, WP33 and WP43 are shipped.
