...
| WP10 | Professions: six mains plus free Cooking; one six-tier recipe book per profession; level visibility and keystone unlocks. Recut Goldsmith around Quartz, Gold, the six G1/G2 gems, Rough→Cut processing, the fixed Setting ladder and both trinket slots; implement universal/cultural/PvP-special recipe ownership and direct cultural-master services. No Gem Detector, Amplifier or Dowsing Rod exists. Retain Alchemist herbs/draughts, Leatherworker, Tailor, Woodcarver and Blacksmith scopes without parallel gear catalogs | open; design-side ready — A1 (signature table), A4 (keystones), A5 (grade names) and E21 (cooking groups incl. the revised food-restore buff model) are decided in `items_crafting.md` §§2.1/2.3/3.3–3.7 (2026-08-13); WP10 also ships the buff/debuff icon framework of `inventory_equipment.md` §5; A3 (bag refinement) stays open in the TODO and touches only §6b.1's refinable-family list, not the book structure; specs: `professions.md`, `items_crafting.md`, `inventory_equipment.md` | WP26, WP33, WP43, WP44 |
...
- **WP5** is design-complete (A2/A6 decided 2026-08-13,
  ...
  WP1/WP3/WP43. **WP10** is design-side ready (A1/A4/A5/E21 decided
  2026-08-13) and waits only on WP26/WP33/WP43/WP44; A3 stays open but
  gates no book structure.
