...
1. **WP26 — universal bars/furnace**, **WP40 — named-zone map foundation**
   ...
   replaced the former exact-T2 authority, and independently accepted R1 now
   provides the fixed 2D evaluator plus canonical SVG. Mandatory V1 user
   visual approval is next. Read
