...
**15 are shipped**: WP0–WP4, WP6, WP7, WP15, WP18, WP19, WP25, WP35,
WP36, WP38 and WP39. WP16 is a canceled tombstone and is not shipped. Every
...
1. **WP43 — Material Progression Retrofit.** It is the next integration root:
   WP25 shipped the legacy strata/material implementation, and WP43 migrates
   it to the authoritative natural-depth, harvest-tier, naming and regional
   resource contract.
...
When WP43 ships, the prerequisite-first frontier becomes **WP26** (universal
bars/furnace), **WP40** (named-zone map foundation) and **WP44** (economy
rebase). WP40 is already **design-ready**, but code may not begin until its
orchestrator has written and independently reviewed the six-part engineering
brief in `docs/research/mapgen-control.md`. Its 32-seed geometry/supply/
housing audits, capacity simulation and reproducible performance measurements
are mandatory implementation outputs, not open design questions.
...
implementation: running code still uses Emberstone names and the coupled
`maxlevel`/`leveldiff` tool behavior until WP43. Those facts are preserved
as shipped history; none of the target retrofit is marked complete.

**Outstanding shipped runtime caveat:** WP39's GUI combat test remains
outstanding exactly as recorded above. WP25, WP35 and WP36 also retain their
existing not-runtime-tested history; this planning integration does not change
those statuses.
