...
1. **WP26 — universal bars/furnace**, **WP40 — named-zone map foundation**
   ...
   replaced the former exact-T2 authority, and R1 next produces the fixed 2D
   evaluator plus canonical SVG for user approval. Read
