...
1. **WP26 — universal bars/furnace**, **WP40 — named-zone map foundation**
   ...
   under the standing fresh-server mode in AGENTS.md. Fresh-terrain visual
   acceptance and the remaining R8 gates stay open.
...
in a backed-up WP25 world. WP45's existing- and new-character runtime passes
