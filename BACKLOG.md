...
| WP8 | Persistent quests: 20 active, kill/item turn-in, NPC dialogue and per-viewer markers, Quest tab and optional three-quest HUD; shared damage/effective-heal participation without party rules | in progress, Round 14; `docs/design/quests.md` | WP1, WP7 |
...
| WP12 | Cartographic world atlas, Map tab, authored zones/roads/settlements and player position; extensible interactive marker layer; no fog of war. Waypoint travel remains visit-unlocked under WP17 | in progress, Round 14 atlas slice; `docs/design/world_map.md`; future waypoint integration separate | WP40; WP17 for travel integration only |
...
| WP20 | Persistent same-faction parties of 2–10; indefinite offline membership/leadership, inviter-bound invitations, management tab and optional name/HP HUD. No party-specific XP, quest-credit, loot or tap rules | in progress, Round 14; `docs/design/parties.md` | WP4 |
