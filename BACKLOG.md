...
| WP12 | Global map showing discovered waypoints and stable named-zone labels/boundaries. Fog of war (potentially adapting the `mcl_maps` approach) is an optional enhancement and may be omitted from the first delivery; map visibility never unlocks waypoint travel, which remains visit-unlocked under WP17 | open | WP17, WP40 |
