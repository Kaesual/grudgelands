...
| WP26 | Two-slot furnace and universal alloy chain: port the compatible dual-input furnace and implement Bronze, Iron, Steel (with mined Coal), Silversteel, Embersteel and Abyssal Steel exactly as `items_crafting.md` specifies. It owns processed universal bars only; G1/G2, culture finishes, PvP specials, trinkets, claims, kings and dragons remain in their dedicated WPs | open; ready against WP43's shipped replacement material ids/APIs; task card: `docs/research/wp26-task-card.md` | WP43 |
...
2. **WP5 — loot/affixes**, **WP26 — universal bars/furnace** and
   **WP44 — economy rebase** are independently ready. WP5 and WP26 have
   executable task cards; all three use the shipped material foundation.
...
- **WP5** is design-complete (A2/A6 decided 2026-08-13,
  ...
  2026-08-13) and waits only on WP26/WP43/WP44; WP33 is shipped.
