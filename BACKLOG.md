...
- **WP10 ← `TODO-design-crafting-rework.md` A1/A4/A5/E21** (signature
  ...
  are not
- **WP25 is design-unblocked since 2026-08-08**: B7/B8 are decided and
  folded into `items_crafting.md` §3.0.1 (ore bands, scarcities, the ore
  `level` rule, Abyssal Crystal's placement) and §3.0.4 / `world.md` §2
  R6 (the stratum table, textures, placement, the pick `maxlevel`
  re-parameterisation). It is the root of the whole material chain:
  WP26 → WP27 → WP28 → WP29 all hang off it, and so does WP24's isle
  rock
...
- **WP24 (housing)** is design-unblocked since 2026-08-07 (world.md §5
  ...
  before the strata and their `grug_materials.stratum_node_for(y)`
  lookup exist (B7, the design half of that, is decided 2026-08-08 —
  what is left is WP25's code). It still needs the **fix in
