...
- **WP5** waits on the refined-marker/description question in
  `TODO-design-crafting-rework.md` A6 (the A2 affix vocabulary is decided,
  `items_crafting.md` §6b.4). **WP10** waits on A1/A4/A5/E21
