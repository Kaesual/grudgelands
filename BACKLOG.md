...
1. **WP26 — universal bars/furnace**, **WP40 — named-zone map foundation**
   ...
   replaced the former exact-T2 authority. R1 and the V1b technical package
   are independently accepted; user visual approval of the revised SVG is
   next. Read
