...
1. **WP26 — universal bars/furnace**, **WP40 — named-zone map foundation**
   ...
   evidence are also independently accepted. R7's native/cutover contract and
   WP33 decisions D1-D6 are ratified; their registrations, P9G successor and
   consumer migration are next before the writer may activate. Read
