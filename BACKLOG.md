...
| WP31 | Mounts: implement the four decided level-15/30/45/60 riding tiers, owner-bound item/ephemeral-entity lifecycle, damage dismount, Holy-Grounds flight, enemy-territory land-only restriction and WP40 ocean/channel no-flight masks. WP44 converts the fixed 15m/45m/2h/5h reliable-net-income targets into prices. Do not invent the still-open asset, entity-damage, mounting-in-combat, underground-flight, ceiling/drift, swimmer-exhaustion or variant details; riding itself is sold by the capital job trainers (D20 decided 2026-08-13, `mounts.md` §1) | open; blocked on `TODO-design-crafting-rework.md` D12/D14–D19 | WP28, WP40, WP44 |
...
| WP33 | Gathering and cultural surface resources: register the six herb/spice nodes, cooking ingredients and found-only food sources, plus ordinary signature woods and other gatherable culture materials assigned by the final race-region/zone palettes. Enforce Alchemist-only healing-herb harvest, universal spices and equivalent faction access; no housing-exclusive resource exists | open; exact placement uses WP40 zone ids and WP43 material ids | WP40, WP43 |
...
| WP40 | **Named-zone world foundation:** implement the 38-zone hybrid-v7 map from `docs/design/world_zones.md` §§7–14: stable zone/race-region/territory/PvP fields; exact adjacency and separate boat graph; independently authored mainland silhouettes; Holy Grounds; final starts/capitals/roads/water; ten housing masks; shallow hard-protection versus mutable claim-excluded envelopes; 80-node shelf, full-depth deep ocean, immutable dragon channels and both offshore island envelopes; logical biomes, level fields, anchors and resource/supply geometry. **Before any code change**, write and independently review the six-part engineering brief required by `docs/research/mapgen-control.md` (analytic chunk-order-independent anchor heights; rewrite shell/cut-fill and intersected caves/dungeons/liquids/strata; native/authored decorations and water normalization; generic versus cultural resource placement; registry initialization/memory strategy; benchmark corpus/thresholds). Production uses one v7 emerge thread. Run and record the fixed 32-seed geometry/topology/route/housing/supply audit, capacity simulation and reproducible WP18/WP36-relative performance measurements before integration. Fresh-world-only | open; **design-ready**, engineering brief and measured outputs are implementation gates, not open game-design questions | WP6, WP18, WP43 |
...
WP36, WP38, WP39 and WP43. WP16 is a canceled tombstone and is not shipped. Every
...
1. **WP26 — universal bars/furnace**, **WP40 — named-zone map foundation**
   ...
   roots. WP40 is design-ready, but code may not begin until its orchestrator
   has written and independently reviewed the six-part engineering brief in
   `docs/research/mapgen-control.md`; the fixed 32-seed geometry/supply/housing
   audits, capacity simulation and reproducible performance measurements are
...
- **WP5** is design-complete (A2/A6 decided 2026-08-13,
  ...
  2026-08-13) and waits only on WP26/WP33/WP43/WP44.
- **WP27 → WP29 → WP28** is the replacement-before-deletion equipment/tool
  chain after WP26/WP43. WP30 then consumes WP29 and WP44.
- **WP13** and **WP33** consume WP40's final anchors/zones and WP43's resource
  ids. **WP34** consumes WP13, WP40, WP43 and WP44; it is not an independent
  next package.
...
- **Two known deviations, design vs. code (2026-08-08)** — both now owned
  ...
  - `world.md` §2 R4 says *nothing regrows* except inside hard-protected
    functional sockets — mining camps only, 10–15 nodes at the region's tier
    on a 2–4 h respawn, with mutable claim-excluded camp shells — while the
    shipped `grug_nodes/ore_respawn.lua` still
