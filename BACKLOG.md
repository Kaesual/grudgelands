...
| WP32 | Farming: adapt a crop layer to active open-world housing claims. Round 9 first adds MAP-B crop soil and growable Cooking plants; the later claim integration includes the exhaustive ten-node horizontal growth audit for every crop/sapling/bamboo/growable variant and preserves point-based ownership across claim boundaries | open; V1, scheduled in Round 9 after MAP-B and Cooking | WP10, WP24, WP33 |
...
1. **WP13 — world structures**, selected by the user after WP40 completion.
   ...
   final boundary rings are populated. Playtest 11 is the next GUI gate. The
...
- **WP31** is V1 work scheduled in Round 9 under the decided scope in
  `TODO-round9.md`; WP44 still measures its four price targets.
- **WP32** is V1 work scheduled in Round 9 after MAP-B and Cooking; its active-
  claim integration still depends on WP24.
