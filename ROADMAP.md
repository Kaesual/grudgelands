...
- [ ] **WP40 — Named-zone world foundation:** replace the WP18 surface with
  ...
  2026-08-25; R0, R1 and V1b technically accepted 2026-08-25.** R0
  replaced the unfinished exact-T2 partition/topology path; R1 now provides
  one fixed pure 2D model and canonical SVG, and V1b adds bounded shared-warp
  borders, pinned curved routes and coherent visible water. User visual
  approval is next and precedes layout freeze, height and mapgen integration.
