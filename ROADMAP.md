...
- [ ] **WP40 — Named-zone world foundation:** replace the WP18 surface with
  ...
  2026-08-25; R0, R1, V1b and V1c technically accepted 2026-08-25.** R0
  replaced the unfinished exact-T2 partition/topology path; R1 now provides
  one fixed pure 2D model and canonical SVG; V1c adds bounded shared-warp
  borders, pinned curved routes, complete bays and coherent visible water.
  User visual approval of V1c is next and precedes layout freeze, height and
  mapgen integration.
