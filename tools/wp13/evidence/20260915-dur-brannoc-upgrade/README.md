...
Written against `main` at `922bfd92`.
...
| `renders/` | Dur Brannoc as BUILT, drawn from TSVs the probe read back out of the finished map on the user gate seed |
...
3. `renders/district-ne.png` — a quarter with its lanes, which is the thing this
   package exists for.
4. `timing.txt` — 366 869 cells of 400 000, beside Highcourt's 376 274.
