#!/usr/bin/env bash
# Static gates for the WP13 round-3 Highcourt fill lane, the same set the
# previous WP13 increments ran (tools/wp13/evidence/20260914-character-visuals/
# static.sh): parser and SETGLOBAL per changed file and tree-wide, the five
