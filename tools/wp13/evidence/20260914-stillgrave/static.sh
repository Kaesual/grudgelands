#!/usr/bin/env bash
# Static gates for the WP13 increment-5 undead start, exactly the set the two
# previous increments ran: parser and SETGLOBAL per changed file and
...
echo "== the one changed Python file compiles =="
