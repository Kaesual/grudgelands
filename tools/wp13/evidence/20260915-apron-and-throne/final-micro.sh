#!/usr/bin/env bash
# The single bounded final-byte process for playtest round 1: every WP13
...
out="$repo/tools/wp13/evidence/20260915-apron-and-throne/final-micro"
cd "$repo"
rm -rf "$out"
mkdir -p "$out"
...
( cd "$repo" && sha256sum \
	tools/wp13/evidence/20260915-apron-and-throne/final-micro/micro-luajit.tsv \
	tools/wp13/evidence/20260915-apron-and-throne/final-micro/micro-puc51.tsv ) \
	>"$out/digests.txt"
