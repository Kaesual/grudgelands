#!/usr/bin/env bash
# Static gates for the Lethariel increment, the same set every WP13 increment
...
CHANGED=(
	...
	mods/MAPGEN/grug_mapgen/wp13/lethariel_districts.lua
	mods/MAPGEN/grug_mapgen/wp40/r7_lethariel_blueprint.lua
