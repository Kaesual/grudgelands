...
core.register_on_mods_loaded(function()
 ...
 local p={get_player_name=function()return "r17_probe"end,
 ...
 core.log("action",("[r17_integration] PASS homes=%d neutral=%d aggressive=%d critter=%d markers=%d"):
  format(#homes,neutral,aggressive,critter,count))
 core.after(0,function()core.request_shutdown("Round 17 registration complete",false,0)end)
end)
