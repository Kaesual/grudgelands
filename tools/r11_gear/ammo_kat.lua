return function(repo)
 ...
 _G.core={registered_items=defs,register_craftitem=function(n,d)defs[n]=d end,get_item_group=function(n,g)return((defs[n]or{}).groups or{})[g]or 0 end,register_on_joinplayer=function()end,register_allow_player_inventory_action=function(f)allow[#allow+1]=f end,register_on_player_inventory_action=function(f)changed[#changed+1]=f end}
 ...
 local player={get_inventory=function()return inv end}
 ...
 assert(inv:is_empty("grug_quiver_content")and grug_inventory.ammo_count(player)==1)
 return "ammo\tquiver-first\tmain-fallback\tatomic-unequip\n"
end
