return function(root)
	...
	local crop_visual = include("mods/ITEMS/grug_nodes/crop_visual.lua")
	...
	contains(farming, "grug_nodes.crop_visual(row.key, stage,", "shared stage visual call absent")
	contains(crop_visual, 'key == "salt_crust"', "salt visual branch absent")
	contains(crop_visual, 'drawtype = "nodebox"', "salt nodebox absent")
	contains(crop_visual, 'type = "vertical_frames"', "salt animation absent")
