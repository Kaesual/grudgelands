...
for mutation in recipe_tier cooking_items cooking_tier shared_cooldown greater_cooldown food_stack elixir_clock elixir_exclusive apothecary_cap item_level authorizer authorizer_allow cave_cap; do
