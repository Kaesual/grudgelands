...
core.register_craftitem("grug_r13_stations_probe:single", {description = "Single fixture output"})
...
grug_jobs.register_recipe({profession = "weaponsmith", tier = 1, station = "forge",
	inputs = {{"grug_r13_stations_probe:input", "grug_r13_stations_probe:jar"}},
	output = "grug_r13_stations_probe:single", hint = "Single-result return fixture"})
