-- Round 14 production quest catalog, staged until the POI lane publishes all
-- village/outpost/camp quest sockets. Move byte-for-byte to
-- mods/PLAYER/grug_quests/content.lua only with that integration.
...
local cultures = {
	{
		...
		village = "anchor_013", outpost = "anchor_025", camp = "anchor_049",
		...
		descriptions = {
			...
			"Boars and ibex have loosened stone over Copper Road. Clear the approach, then follow it to Copperfell.",
	...
	},
	{
		...
		village = "anchor_015", outpost = "anchor_029", camp = "anchor_051",
		...
		descriptions = {
			...
			"Boars and wild turkeys crowd Mill Road. Clear the way, then carry Elian's word to Goldmead.",
	...
	},
	{
		...
		village = "anchor_017", outpost = "anchor_033", camp = "anchor_053",
		...
		descriptions = {
			...
			"Poachers cut living boughs on the Starbough road. Stop them, then bring Saelin's warning to Ilyra.",
		...
		targets = {{"grug_mobs:boar"}, false, {"grug_mobs:giant_rat", "grug_mobs:boar"},
			{"grug_mobs:zombie", "grug_mobs:boar"}, {"grug_mobs:fox"}, {"grug_mobs:poacher"},
	...
	},
	{
		...
		village = "anchor_019", outpost = "anchor_037", camp = "anchor_055",
	...
	},
	{
		...
		village = "anchor_021", outpost = "anchor_041", camp = "anchor_057",
		...
		descriptions = {
			...
			"Sun-dried husks block Redtusk Road. Break them, then carry Gara's greeting to Borak.",
	...
	},
	{
		...
		village = "anchor_023", outpost = "anchor_045", camp = "anchor_059",
		...
		descriptions = {
			...
			"Jungle lynx stalk Raincall Road. Thin them, then take Zalima's words to Daro.",
