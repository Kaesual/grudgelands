...
local repo = arg[1] or "."
local fixtures = {
 "r15_map/kat.lua", "r15_quests/check_catalog.lua", "r15_poi/poi_micro_kat.lua",
 "r15_hud/hud_micro.lua",
}
...
for _,path in ipairs(fixtures) do
 ...
 if type(result)=="function" then
  local canonical=result(repo);if canonical then io.write(canonical) end
 end
 collectgarbage("collect")
end
print("round15-final-micro: PASS fixtures="..#fixtures)
