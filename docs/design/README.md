...
| [`progression.md`](progression.md) | Leveling pace, talent cadence, Claim Stone milestones, death/respawn and named-zone quest gates. | **partial**: the PvP-death XP-loss exemption remains deliberately unresolved before WP9. |
...
| [`mounts.md`](mounts.md) | Universal riding at levels 15/30/45/60; exact land/flight speeds, income-priced purchases, owner-bound item plus ephemeral entity, damage dismount and authored Holy-Grounds/enemy/ocean restrictions. | **decided geography and lifecycle, not built**; explicit remaining questions stay in `TODO-design-crafting-rework.md`. |
