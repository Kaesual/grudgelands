...
| [`scout.md`](scout.md) | The fourth class (Scout): mana, leather, bow/dagger/sword/greataxe routes, a four-ability base kit, ballistic arrows, Sprint's bounded speed exception and stealth deferred whole to §8. | **decided** (2026-09-16); the Round 11 class, abilities, talents, starter kit and trader integration are delivered. |
