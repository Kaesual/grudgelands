...
**Preparation draft — not a delivery notice.** Implementation and independent
reviews are still running. Root updates this header after main integration,
synchronization and push. Offline checks do not establish GUI acceptance.
