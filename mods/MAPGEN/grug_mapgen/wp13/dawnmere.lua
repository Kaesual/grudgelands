...
local function loader(directory)
	...
	local SOCKETS = {
		...
		-- it. Both stand at features Dawnmere already has, so no cell moves and
		-- the settlement identity is untouched.
		--
		-- A field hand on the lane at the north edge of the tilled strips, and
