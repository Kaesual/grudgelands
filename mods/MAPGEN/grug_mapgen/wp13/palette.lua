...
M.optional = {"bale", "bed_fancy", "bench_seat", "board_table", "crop",
	...
	"hedge_stem", "light_beacon", "light_hanging", "mat", "shutter",
...
M.races.elf = {
	...
	ground_bare = "default:dirt",
	subsoil = "default:dirt",
	path = "grug_decor:darkage_marble_tile",
	plaza = "grug_decor:darkage_slate_tile",
	plaza_edge = "grug_decor:darkage_serpentine",
	stepping = "grug_decor:xdecor_stonepath",
	rubble = "default:silver_sandstone",

	foundation = "grug_decor:darkage_marble",
