...
local source = {
	...
	height_revision_id = "wp40-height-quality-v4",
...
source.anchor_profiles = {
	...
	{id="village",shape="gentle_grade",building_core_width=40,fitting_width=96,blend_width=160,max_cut=8,max_fill=6,force_native_dungeon=false},
	{id="outpost",shape="gentle_grade",building_core_width=28,fitting_width=64,blend_width=112,max_cut=8,max_fill=6,force_native_dungeon=false},
	{id="bandit_home",shape="gentle_grade",building_core_width=28,fitting_width=64,blend_width=112,max_cut=8,max_fill=6,force_native_dungeon=false},
	{id="bandit_frontier",shape="gentle_grade",building_core_width=28,fitting_width=64,blend_width=112,max_cut=8,max_fill=6,force_native_dungeon=false},
	{id="mine",shape="gentle_grade",building_core_width=32,fitting_width=80,blend_width=128,max_cut=8,max_fill=6,force_native_dungeon=false},
	{id="mirefolk",shape="shallow_marsh_island",building_core_width=28,fitting_width=64,blend_width=112,max_cut=8,max_fill=6,force_native_dungeon=false},
	{id="clash",shape="battlefield_grade",building_core_width=28,fitting_width=64,blend_width=112,max_cut=8,max_fill=6,force_native_dungeon=false},
	{id="dragon",shape="arena_terrace",building_core_width=48,fitting_width=96,blend_width=160,max_cut=8,max_fill=6,force_native_dungeon=false},
	{id="apex_mine",shape="mine_terrace",building_core_width=48,fitting_width=96,blend_width=160,max_cut=8,max_fill=6,force_native_dungeon=false},
	{id="rare_route",shape="patrol_route",building_core_width=16,fitting_width=32,blend_width=64,max_cut=3,max_fill=2,force_native_dungeon=false},
}
