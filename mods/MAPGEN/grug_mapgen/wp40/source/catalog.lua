...
source.geometry_policies = {
	...
	relief_composition = {
		...
		landmark_overlap_rule = "compose_all_strictly_positive_Q16_collars",
		landmark_priority_order=
			"ascending_base_h_priority_higher_applied_last",
		landmark_priority_tie = "reject",
		evaluation_order={"raw_owning_zone_profile",
			"all_positive_landmark_collars_qlerp_previous_H_to_replacement_H",
	...
	boundary_displacement = {
		...
		shared_boundary_clip_endpoint_rule="each_enumerated_interval_supplies_its_authored_from_and_to_integer_endpoint_for_attachment_or_ordinary_R18_obligation_probes_after_R18_fixes_one_interval_R19_exhaustively_resolves_the_closed_candidate_tuple_for_its_one_or_two_declared_bay_transition_endpoints",
		...
		shared_boundary_incidence_run_obligations="for_each_enumerated_interval_each_attachment_or_ordinary_junction_obligation_uses_that_intervals_authored_endpoint_and_each_transition_applies_the_existing_R16_direct_or_diagonal_resolution_only_to_that_intervals_authored_endpoint_an_interval_qualifies_only_if_both_ordered_R18_obligations_pass",
		shared_boundary_incidence_run_selection="select_the_exactly_one_interval_with_both_complete_ordered_R18_endpoint_obligations_zero_or_multiple_reject_no_longest_first_rank_or_numeric_index_tie_then_apply_R19_terminal_selection_inside_that_fixed_interval_without_reselecting_the_interval",
		shared_boundary_incidence_control_clip="keep_exactly_the_nonempty_unique_contiguous_authored_shifted_control_subsequence_whose_canonical_x_z_identities_lie_between_the_selected_final_endpoint_incidences_for_an_R19_edge_each_joint_one_or_two_transition_terminal_tuple_clips_the_combined_subsequence_applies_existing_R16_controls_and_is_probe_rerastered_by_the_sole_final_raster_pipeline_only_the_selected_complete_probe_bytes_are_materialized",
		...
		shared_boundary_incidence_excluded_dry="every_nonselected_dry_interval_and_every_dry_fragment_between_an_R19_terminal_and_its_selected_maximal_intervals_authored_endpoint_must_be_owned_exactly_once_by_a_final_Bank_or_dry_Face_and_by_no_final_land_edge_or_terminal_identity_else_reject",
		...
		shared_boundary_incidence_reject="missing_duplicate_or_mixed_obligation_zero_or_multiple_complete_intervals_zero_complete_transition_terminals_empty_nonunique_or_noncontiguous_ordinary_edge_interval_or_selected_result_control_subsequence_discarded_required_terminal_foreign_gap_or_excluded_fragment_missing_duplicate_or_land_edge_owned_rejects_without_fallback_while_an_empty_or_noncontiguous_per_tuple_combined_clip_fails_only_that_tuple",
		...
		bay_edge_transition_direct="E_is_each_eligible_authored_station_incidence_enumerated_toward_the_interior_from_the_declared_from_or_to_side_of_the_current_selected_maximal_final_dry_interval_if_E_is_a_same_bay_final_dry_boundary_candidate_R16_resolves_E_unchanged_for_that_candidate_probe",
		...
		bay_edge_transition_application="R16_resolve_each_eligible_terminal_incidence_inside_the_R18_selected_maximal_interval_then_for_each_closed_one_or_two_endpoint_candidate_tuple_clip_the_combined_retained_control_subsequence_and_probe_the_existing_sole_final_edge_raster_R19_selects_the_unique_complete_tuple_and_materializes_its_already_resolved_edge_bytes_once_no_post_raster_append_reraster_or_snap",
		...
		bay_edge_transition_scalar_scope="E_W_any_derived_elbow_and_the_R19_terminal_are_resolved_only_after_record_scalar_materialization_R16_R17_R18_and_R19_never_enter_or_change_extreme_scalar_record_identity_or_value_no_pre_correction_C1_pool_is_promotable_and_the_sole_promotable_complete_4096_pool_and_selected_winners_are_generated_only_against_later_approved_immutable_post_R19_Source_and_compiler_pins",
		...
		bay_edge_transition_terminal_policy_id="joint_bank_incidence_transition_terminal_v1",
		bay_edge_transition_terminal_candidates="for_each_declared_transition_endpoint_of_the_fixed_R18_selected_maximal_dry_interval_every_station_incidence_except_the_opposite_interval_endpoint_is_eligible_exactly_when_it_has_the_immediately_adjacent_in_interval_station_away_from_the_declared_endpoint_run_R16_for_every_eligible_incidence_collect_every_successful_resolved_candidate_then_exhaustively_enumerate_the_cartesian_tuple_of_one_candidate_per_declared_transition_endpoint_with_no_other_pruning_first_success_scan_or_private_order",
		bay_edge_transition_terminal_dependency="an_edge_has_exactly_one_or_two_declared_transition_endpoints_each_transitions_two_declared_incident_Banks_are_exactly_one_start_and_one_end_and_each_other_terminal_is_aperture_or_Wing_derived_never_an_edge_transition_so_each_joint_edge_tuple_probe_is_finite_and_acyclic",
		bay_edge_transition_terminal_complete="for_each_candidate_tuple_require_a_nonempty_combined_contiguous_R7_control_subsequence_candidate_clip_it_apply_all_R16_E_then_optional_T_controls_and_probe_the_sole_final_edge_raster_require_unique_eight_connected_no_X_cross_final_dry_record_envelope_valid_probe_bytes_each_resolved_terminal_as_its_declared_probe_edge_endpoint_bind_previous_to_the_immediately_adjacent_probe_final_edge_station_away_then_require_both_incident_Banks_of_every_transition_to_complete_under_the_unchanged_R11_candidate_water_side_DFS_repeat_and_X_cross_rules",
		bay_edge_transition_terminal_selection="the_least_complete_joint_edge_tuple_across_the_full_finite_cartesian_set_is_selected_under_the_declared_total_order_total_retreat_from_the_declared_endpoints_then_maximum_per_endpoint_retreat_then_elbow_terminal_count_then_sorted_resolved_terminal_set_then_sorted_previous_set_then_probe_bytes_under_canonical_orientation_two_distinct_tuples_with_the_same_terminal_previous_and_probe_edge_byte_identity_are_duplicate_authority_and_reject_zero_complete_tuples_reject_enumeration_iteration_order_first_longest_nearest_scan_backstep_side_flip_and_private_tie_remain_forbidden_the_declared_order_is_selection_among_complete_tuples_not_pruning",
		bay_edge_transition_terminal_application="promote_only_the_selected_joint_tuple_probe_final_edge_bytes_then_materialize_the_shared_edge_and_all_incident_Banks_once_excluded_dry_columns_keep_owner_validation_and_no_unselected_R16_resolution_probe_edge_or_probe_Bank_path_is_serialized",
		bay_edge_transition_terminal_bounds="per_endpoint_at_most_selected_interval_station_count_minus_one_eligible_incidences_and_resolved_candidates_each_edge_has_at_most_two_transition_endpoints_and_at_most_the_checked_product_of_their_candidate_counts_joint_tuples_each_tuple_runs_at_most_four_existing_R11_traces_with_existing_per_Bay_8N_frame_N_stack_and_N_minus_1_main_step_caps_all_counts_products_and_neighbor_arithmetic_checked_safe_integer",
		bay_edge_transition_terminal_reversal="authored_edge_reversal_swaps_endpoint_direction_and_the_one_or_two_endpoint_candidate_tuple_orientation_but_resolves_the_same_world_terminals_and_probe_previous_stations_probe_final_edge_bytes_reverse_exactly_and_Bank_consumers_reverse_only_finished_bytes",
		bay_edge_transition_terminal_reject="candidate_outside_interval_malformed_or_missing_adjacent_away_station_duplicate_resolved_tuple_identity_nonadjacent_or_missing_probe_anchor_edge_overlap_other_than_terminal_unreachable_incident_Bank_zero_complete_joint_tuples_changed_R7_scalar_identity_excluded_fragment_owner_failure_or_face_and_Whole_topology_failure_rejects_without_scan_snap_tail_connector_or_seed_fallback",
	...
	world_partition = {
		...
		bay_mouth_aperture_policy_id="maximal_contiguous_nonwrapping_half_open_exact_base_bay_perimeter_stations_v2",
		...
		bay_mouth_aperture_detached_shoulder="per_aperture_end_and_per_station_order_at_most_one_base_bay_passing_station_separated_from_the_run_by_exactly_one_non_passing_station_is_admitted_as_a_detached_shoulder_station_outside_membership_payload_and_ownership_recorded_on_the_compiled_aperture_and_skipped_by_the_bank_shoulder_next_dry_station_away_resolution_every_other_passing_station_outside_the_run_rejects",
...
local function bay_edge_transition(id,bay_id,edge_id,edge_endpoint,
	...
	return {id=id,bay_id=bay_id,edge_id=edge_id,edge_endpoint=edge_endpoint,
		...
		terminal_selection_policy_id="joint_bank_incidence_transition_terminal_v1",
...
local function bay_mouth_aperture(id,bay_id,perimeter_id,mouth_vertex_index,
	...
	return {id=id,bay_id=bay_id,mouth_sample_index=1,
		...
		policy_id="maximal_contiguous_nonwrapping_half_open_exact_base_bay_perimeter_stations_v2",
...
source.landmarks = {
	...
	landmark(59,"gravesalt_warcoast","front_gravesalt_escarpment","capsule",-2420,0,80,230,"highland"),
	...
	landmark(67,"skyglass_warcoast","front_skyglass_canopy","capsule",2420,0,80,230,"highland"),
