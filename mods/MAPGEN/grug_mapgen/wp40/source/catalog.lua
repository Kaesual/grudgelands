...
source.geometry_policies = {
	...
	boundary_displacement = {
		...
		shared_boundary_clip_retained_rule="exactly_one_consecutive_final_dry_station_interval_for_each_of_the_fifty_five_edges_without_a_bay_edge_transition",
		shared_boundary_clip_endpoint_rule="each_enumerated_interval_supplies_its_authored_from_and_to_integer_endpoint_for_obligation_probes_a_declared_bay_transition_may_resolve_its_endpoint_through_the_checksum_bound_R16_policy_and_an_attachment_uses_the_joint_station_policy",
		shared_boundary_incidence_run_policy_id="joint_terminal_incidence_complete_dry_run_v1",
		shared_boundary_incidence_run_scope="exactly_the_six_land_edges_projected_in_source_order_from_the_eight_bay_edge_transition_rows_all_other_fifty_five_edges_require_exactly_one_final_dry_station_interval",
		shared_boundary_incidence_run_projection="derive_each_six_edge_obligation_tuple_coordinate_free_from_the_existing_transition_and_perimeter_attachment_rows_in_authored_from_then_to_endpoint_order",
		shared_boundary_incidence_run_enumeration="enumerate_all_maximal_consecutive_final_dry_intervals_in_the_provisional_selected_R7_station_bytes",
		shared_boundary_incidence_run_obligations="for_each_enumerated_interval_E_is_that_intervals_authored_from_or_to_endpoint_and_each_transition_attachment_or_ordinary_junction_obligation_is_probe_resolved_only_against_that_E_an_interval_qualifies_only_if_both_ordered_obligations_pass",
		shared_boundary_incidence_run_selection="select_the_exactly_one_interval_satisfying_the_complete_ordered_endpoint_tuple_zero_or_multiple_reject_no_longest_first_or_numeric_index_tie",
		shared_boundary_incidence_control_clip="keep_exactly_the_nonempty_unique_contiguous_authored_shifted_control_subsequence_whose_canonical_x_z_identities_belong_to_the_selected_station_interval_then_apply_existing_transition_and_attachment_controls_and_the_sole_final_reraster",
		shared_boundary_incidence_scalar_scope="nonselected_shifted_controls_remain_unchanged_upstream_R7_scalar_samples_but_never_enter_final_boundary_geometry_no_re_C_rescore_selector_change_or_post_raster_splice",
		shared_boundary_incidence_excluded_dry="every_nonselected_dry_fragment_must_be_owned_exactly_once_by_a_final_Bank_or_dry_Face_and_by_no_final_land_edge_or_terminal_identity_else_reject",
		shared_boundary_incidence_reversal="reverse_the_authored_edge_and_swap_from_to_obligations_resolves_the_same_world_interval_and_byte_exact_reversed_final_edge",
		shared_boundary_incidence_reject="missing_duplicate_or_mixed_obligation_zero_or_multiple_complete_intervals_empty_nonunique_or_noncontiguous_control_subsequence_discarded_required_terminal_foreign_gap_or_excluded_fragment_missing_duplicate_or_land_edge_owned_rejects_without_fallback",
		bay_edge_transition_policy_id="direct_candidate_or_same_bay_diagonal_elbow_v1",
		bay_edge_transition_source="exactly_eight_coordinate_free_rows_bind_referenced_bay_land_edge_endpoint_and_the_two_incident_bank_components_in_source_component_order",
		bay_edge_transition_direct="E_is_the_authored_from_or_to_endpoint_of_the_current_enumerated_final_dry_interval_if_E_is_a_same_bay_final_dry_boundary_candidate_select_E_unchanged_for_that_interval_probe",
		bay_edge_transition_diagonal_precondition="otherwise_E_must_be_final_strict_dry_and_have_no_cardinal_same_bay_or_foreign_water_neighbor_W_is_the_immediate_discarded_provisional_edge_station_toward_the_bay_E_to_W_must_be_exactly_diagonal_and_W_must_be_final_planned_water_owned_only_by_the_referenced_bay_after_Base_Wings_and_single_pass_notch_fill",
		bay_edge_transition_elbows="the_two_exact_orthogonal_elbows_W_x_E_z_and_E_x_W_z_must_be_distinct_strict_dry_in_footprint_same_bay_boundary_candidates_select_lexicographically_least_x_then_z",
		bay_edge_transition_application="insert_the_selected_elbow_as_terminal_control_after_unique_incidence_complete_interval_and_retained_control_subsequence_selection_and_before_the_existing_sole_final_edge_raster_then_run_all_ordinary_edge_validation_no_post_raster_append_or_snap",
		bay_edge_transition_identity="edge_and_both_declared_incident_bank_components_consume_one_resolved_terminal_station_id_and_byte_exact_x_z_without_second_resolution_defensive_alias_free_copies_are_permitted",
		bay_edge_transition_mask_source="resolve_each_transition_exactly_once_against_world_partition_final_planned_water_after_single_pass_same_bay_raw_mask_degree_one_notch_v1_never_select_against_raw_water_then_revalidate_or_reselect",
		bay_edge_transition_scalar_scope="E_W_and_any_derived_elbow_are_resolved_only_after_record_scalar_materialization_R16_R17_and_R18_never_enter_or_change_extreme_scalar_record_identity_or_value_no_pre_correction_C1_pool_is_promotable_and_the_sole_promotable_complete_4096_pool_and_selected_winners_are_generated_only_against_later_approved_immutable_post_R18_Source_and_compiler_pins",
		bay_edge_transition_reject="missing_duplicate_malformed_or_mixed_transition_row_nonincident_bank_foreign_bay_nondry_E_cardinal_water_at_noncandidate_E_nondiagonal_or_nonadjacent_W_wrong_W_owner_invalid_elbow_repeat_X_cross_or_final_edge_validation_failure_rejects_without_fallback",
		shared_boundary_attachment_policy_id="joint_perimeter_station_endpoint_before_final_raster_v1",
		shared_boundary_attachment_candidate="final_displaced_perimeter_then_each_enumerated_edge_interval_yields_its_authored_endpoint_E_for_a_probe_then_the_final_displaced_declared_perimeter_segment_yields_A",
		...
		shared_boundary_attachment_final="controls_outside_the_selected_final_dry_interval_are_removed_where_selection_is_the_sole_ordinary_interval_or_the_unique_exact_six_incidence_complete_interval_A_is_zero_displacement_terminal_control_and_both_span_boundaries_before_sole_final_edge_raster_provisional_run_not_exported",
		shared_boundary_attachment_interior="all_final_stations_after_A_strict_footprint_interior_eight_connected_one_run",
		shared_boundary_clip_reject="empty_run_interior_rejection_second_retained_run_on_an_ordinary_edge_or_failure_of_the_declared_six_edge_incidence_complete_run_policy",
		shared_boundary_clip_forbidden="emitted_E_to_A_connector_post_raster_snap_inserted_float_or_rational_intersection_private_connector_geometry_or_undeclared_bay_transition_elbow",
	},
	route_raster = {
	...
	world_partition = {
		id="face_partition_with_bay_capsule_water_v3",schema_version=3,
		bay_mask_authority="raw_four_sample_round_capsule_union_then_two_literal_head_closure_wings_then_one_simultaneous_same_bay_notch_fill",
		bay_notch_fill_policy_id="single_pass_same_bay_raw_mask_degree_one_notch_v1",
		bay_notch_fill_input="immutable_raw_final_planned_water_per_bay_equals_displaced_Base_union_closure_Wings_after_footprint_and_mouth_aperture_equality_precedence_before_any_notch_fill",
		bay_notch_fill_scope="for_each_bay_scan_only_its_finite_expanded_Base_and_Wing_envelope_and_require_P_and_all_eight_neighbours_strictly_inside_that_bay_final_mainland_footprint",
		bay_notch_fill_enumeration="semantic_domain_is_every_integer_P_in_the_deduplicated_envelope_the_complete_finite_candidate_superset_is_each_referenced_bay_raw_water_row_run_first_minus_one_and_finish_plus_one_because_every_three_of_four_cardinal_water_pattern_has_a_horizontal_water_neighbour_and_raw_dry_P_is_immediately_outside_that_run",
		bay_notch_fill_predicate="raw_dry_P_has_exactly_three_cardinal_and_all_four_diagonal_raw_water_neighbours_each_owned_only_by_the_same_referenced_bay_while_the_fourth_cardinal_neighbour_is_raw_dry",
		bay_notch_fill_application="evaluate_every_P_against_the_immutable_raw_mask_collect_all_unique_qualifying_Bay_P_pairs_then_union_them_simultaneously_once_never_iterate_or_feed_a_filled_cell_into_another_decision",
		bay_notch_fill_owner="each_filled_P_is_planned_water_of_its_unique_qualifying_bay_and_uses_that_bay_existing_exact_rational_owner_policy_no_neighbour_owner_copy_rank_snap_or_new_tie",
		bay_notch_fill_precedence="strict_mainland_interior_only_never_perimeter_or_mouth_aperture_equality_and_any_foreign_or_multiple_bay_water_contact_or_multiple_bay_qualification_rejects",
		bay_notch_fill_safe_arithmetic="Base_and_Wing_envelope_min_max_expansion_and_each_of_eight_neighbour_coordinates_use_checked_safe_integer_addition_or_subtraction_before_lookup_all_raw_mask_predicates_reuse_their_existing_exact_product_guards",
		bay_notch_fill_stage="extreme_scalar_records_and_their_4096_selector_identity_and_values_remain_upstream_unchanged_then_raw_mask_then_simultaneous_fill_produces_final_planned_water_then_R16_transition_selection_runs_once_then_bank_trace_face_partition_and_water_owner_resolution_use_that_same_final_mask",
		bay_notch_fill_payload="each_compiled_Bay_carries_policy_id_count_and_one_lexicographically_x_then_z_sorted_dense_array_of_exact_fill_x_z_columns_materialized_once_from_the_raw_mask_all_transition_bank_face_partition_and_owner_consumers_use_those_bytes_without_retracing_reclassification_or_face_inference",
		...
		bay_bank_candidate="final_classifier_dry_mainland_column_including_permitted_dry_perimeter_equality_with_four_neighbor_owned_by_same_final_planned_bay_mask_including_Base_Wings_and_single_pass_notch_fill",
		...
		bay_bank_aperture_transition_policy_id="aperture_dry_direct_or_same_bay_diagonal_shoulder_tail_v1",
		bay_bank_aperture_transition_roster="project_exactly_eight_aperture_dry_terminal_incidences_from_the_twenty_bank_components_one_before_and_one_after_for_each_of_the_four_referenced_mouth_apertures",
		bay_bank_aperture_transition_direct="let_D_be_the_adjacent_dry_authored_aperture_station_A_the_next_dry_station_away_and_W_the_immediately_included_aperture_water_station_toward_the_mouth_if_D_is_a_final_same_bay_bank_candidate_use_rotation_anchor_A_D_unchanged",
		bay_bank_aperture_transition_precondition="otherwise_D_must_be_final_dry_footprint_class_zero_with_no_cardinal_same_bay_or_foreign_water_and_W_must_be_raw_and_final_water_owned_only_by_the_referenced_bay_exactly_diagonal_and_immediately_aperture_included",
		bay_bank_aperture_transition_elbows="evaluate_only_the_two_orthogonal_elbows_W_x_D_z_and_D_x_W_z_exactly_one_must_be_strict_footprint_final_dry_same_bay_candidate_T_zero_or_two_reject_without_order_or_tie",
		bay_bank_aperture_transition_materialization="at_a_start_emit_canonical_prefix_D_T_and_begin_Moore_at_previous_D_current_T_at_an_end_target_T_then_emit_canonical_suffix_T_D_D_remains_the_shared_perimeter_and_bank_terminal_T_is_internal",
		bay_bank_aperture_transition_side="the_non_Moore_tail_in_its_materialized_direction_start_D_to_T_or_end_T_to_D_requires_W_on_the_declared_strict_signed_cross_water_side_and_ordinary_water_side_validation_begins_only_on_the_adjacent_Moore_step",
		bay_bank_aperture_transition_identity="resolve_each_aperture_incidence_once_from_authored_aperture_order_and_membership_without_copied_coordinates_second_resolution_or_changed_canonical_aperture_payload",
		bay_bank_aperture_transition_reversal="select_once_in_component_direction_and_reverse_only_the_finished_bank_bytes_the_terminal_tail_has_no_reverse_reselection",
		bay_bank_aperture_transition_reject="missing_duplicate_or_mixed_aperture_incidence_nondry_D_cardinal_water_at_noncandidate_D_nonunique_or_wrong_W_nondiagonal_W_zero_or_two_valid_elbows_wrong_tail_water_side_or_terminal_identity_drift_rejects_without_fallback",
		bay_bank_nonwing_terminal_resolution="aperture_dry_uses_the_checksum_bound_direct_or_same_bay_diagonal_shoulder_tail_resolution_in_the_separate_authored_bank_terminal_order_land_edge_transition_uses_the_once_resolved_R16_terminal_of_the_final_dry_edge_raster_no_inward_scan_or_private_shift_is_permitted",
		bay_bank_edge_transition_identity="for_each_of_eight_coordinate_free_transition_rows_the_final_edge_and_both_declared_incident_banks_consume_the_same_once_resolved_station_id_and_exact_canonical_x_z_bytes_without_a_second_resolution_defensive_alias_free_copies_are_permitted",
		bay_bank_nonwing_start_half_edge="a_direct_aperture_start_uses_previous_A_current_D_a_shoulder_tail_start_emits_D_then_uses_previous_D_current_T_a_land_edge_start_uses_the_immediately_adjacent_retained_dry_edge_station_away_then_the_resolved_endpoint_each_anchor_is_eight_connected_and_candidate_valid_where_required_and_ordinary_water_side_begins_only_on_the_first_Moore_step",
		...
		classification_precedence={"raw_planned_Base_bay_water_in_strict_mainland_interior_or_own_mouth_aperture_equality_then_closure_Wing_water_in_strict_mainland_interior_then_single_pass_same_bay_notch_fill_in_strict_mainland_interior_only",
	...
	geometry_extreme_selector = {
		...
		attachment_rule="every_positive_displacement_canonical_source_station_scores_exactly_once_even_if_its_shifted_control_or_final_interval_is_not_selected_selector_excludes_only_derived_provisional_E_perimeter_A_elbows_and_other_inserted_final_reraster_stations_that_have_no_source_station_identity",
...
local function perimeter_attachment(id,edge_id,endpoint,perimeter_id,
	...
	return {id=id,edge_id=edge_id,edge_endpoint=endpoint,
		...
		selection_station_rule="current_enumerated_interval_authored_from_or_to_endpoint_E_probe_stage2_only",
		...
		compiled_endpoint_rule="after_the_selected_final_dry_interval_is_the_sole_ordinary_or_unique_exact_six_incidence_complete_interval_discard_outside_terminal_controls_A_is_shared_zero_displacement_terminal_control_before_sole_final_edge_raster_provisional_intervals_not_exported"}
end
...
local function bay_edge_transition(id,bay_id,edge_id,edge_endpoint,
		first_bank_id,second_bank_id)
	return {id=id,bay_id=bay_id,edge_id=edge_id,edge_endpoint=edge_endpoint,
		incident_bank_component_ids={first_bank_id,second_bank_id},
		resolution_policy_id="direct_candidate_or_same_bay_diagonal_elbow_v1",
		candidate_tie_rule="lexicographically_least_x_then_z"}
end
source.bay_edge_transitions={
	bay_edge_transition("bay_edge_transition:land_001:to","bay_elandor_west","land_001","to",
		"bay_bank:elandor_west:hearthpine","bay_bank:elandor_west:copperfell"),
	bay_edge_transition("bay_edge_transition:land_004:from","bay_elandor_west","land_004","from",
		"bay_bank:elandor_west:goldmead","bay_bank:elandor_west:dawnmere"),
	bay_edge_transition("bay_edge_transition:land_004:to","bay_elandor_east","land_004","to",
		"bay_bank:elandor_east:dawnmere","bay_bank:elandor_east:goldmead"),
	bay_edge_transition("bay_edge_transition:land_007:from","bay_elandor_east","land_007","from",
		"bay_bank:elandor_east:starbough","bay_bank:elandor_east:silverleaf"),
	bay_edge_transition("bay_edge_transition:land_010:to","bay_kragmar_west","land_010","to",
		"bay_bank:kragmar_west:stillgrave","bay_bank:kragmar_west:mournfen"),
	bay_edge_transition("bay_edge_transition:land_013:from","bay_kragmar_west","land_013","from",
		"bay_bank:kragmar_west:redtusk","bay_bank:kragmar_west:sunscar"),
	bay_edge_transition("bay_edge_transition:land_013:to","bay_kragmar_east","land_013","to",
		"bay_bank:kragmar_east:sunscar","bay_bank:kragmar_east:redtusk"),
	bay_edge_transition("bay_edge_transition:land_016:from","bay_kragmar_east","land_016","from",
