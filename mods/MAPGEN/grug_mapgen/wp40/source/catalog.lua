...
local source = {
	...
	section_order = {
		...
		"land_edges", "perimeter_attachments", "perimeter_spans", "face_arcs", "zone_faces",
...
source.geometry_policies = {
	...
	boundary_displacement = {
		id="shared_polyline_normal_displacement_t1_hash_v1",schema_version=1,
		input_rule="literal_control_polyline_in_authored_direction",
		sampling_rule="route_raster_policy_integer_sequence",
		tangent_rule="previous_to_next_distinct_sample",
		joint_rule="normalize_sum_incoming_outgoing_unit_q16_normals",
		joint_degenerate_rule="reject_opposite_or_zero_joint_normal",
		normal_rule="authored_left_normal_minus_dz_plus_dx_q16_normalized",
		...
		displacement_rule="qround_noise_times_record_max_displacement",
		control_taper_distance=96,
		control_taper_rule="minimum_t1_smootherstep_distance_over_taper_at_both_segment_ends",
		no_jitter_distance=96,
		no_jitter_rule="zero_inside_then_t1_smootherstep_distance_over_radius",
		...
		damping_rule="multiply_minimum_control_and_no_jitter_damping_q16",
		clip_envelope_by_kind={land_edge="intersection_of_two_incident_face_envelopes",
			mainland_coast="mainland_frame_plus_coastal_shelf",
			bay="authored_centreline_half_width_and_perimeter_projection",
			island_coast="authored_island_ellipse_envelope",fixed="literal_geometry_only"},
		clip_rule="clip_to_kind_envelope_then_reject_topology_or_minimum_width_violation",
		...
		shared_boundary_clip_endpoint_rule="first_and_last_retained_integer_stations",
		shared_boundary_attachment_rule="clipped_endpoint_to_nearest_chebyshev_perimeter_station_lower_canonical_index_tie_without_inserted_station",
		shared_boundary_clip_reject="empty_run_interior_rejection_or_second_retained_run",
		shared_boundary_clip_forbidden="inserted_float_or_rational_intersection_and_private_connector_geometry",
	},
	route_raster = {
	...
	relief_field = {
		...
		raw_height_equation_id="relief_noise_to_inclusive_height_floor_v1",
		raw_height_rule="water_level_plus_min_plus_floor_nonnegative_noise_plus_Q_times_inclusive_span_div_two_Q",
	...
	world_partition = {
		id="face_partition_with_bay_capsule_water_v1",schema_version=1,
		...
		bay_displacement_lanes={left=0,right=1},
		bay_displacement_noise="t1_value_noise_q16_period_256_at_projected_integer_station",
		bay_displacement_taper="smootherstep_from_each_authored_sample_over_96_nodes_zero_at_every_sample",
		bay_displacement_width_rule="side_half_width_q16_equals_base_plus_qround_noise_times_max_displacement_times_taper",
		...
		classification_precedence={"strict_exterior","base_bay_mouth_aperture_equality_owner",
			"ordinary_perimeter_equality_owner","strict_interior_base_bay_owner",
			"strict_interior_closure_wing_owner","strict_interior_dry_zone_face_owner"},
	...
	geometry_extreme_selector = {
		...
		sample_sequence="canonical_integer_boundary_raster_with_duplicate_join_samples_suppressed_keep_earlier",
...
local function perimeter_attachment(id,edge_id,endpoint,perimeter_id,
	...
	return {id=id,edge_id=edge_id,edge_endpoint=endpoint,
		...
		clip_policy_id="canonical_integer_land_run_prefix_suffix_v1",
		geometry_rule="symbolic_edge_to_perimeter_attachment_no_connector_polyline",
		compiled_endpoint_rule="first_or_last_retained_integer_boundary_station_stage2_only"}
end
