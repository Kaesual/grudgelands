...
source.geometry_policies = {
	...
	boundary_displacement = {
		...
		shared_boundary_clip_endpoint_rule="nonattached_first_and_last_retained_integer_stations_except_a_declared_bay_edge_transition_may_resolve_that_retained_endpoint_through_the_checksum_bound_direct_candidate_or_same_bay_diagonal_elbow_policy_attached_endpoint_uses_joint_station",
		...
		bay_edge_transition_direct="E_is_the_declared_first_or_last_retained_dry_provisional_edge_station_if_E_is_a_same_bay_final_dry_boundary_candidate_select_E_unchanged",
		bay_edge_transition_diagonal_precondition="otherwise_E_must_be_final_strict_dry_and_have_no_cardinal_same_bay_or_foreign_water_neighbor_W_is_the_immediate_discarded_provisional_edge_station_toward_the_bay_E_to_W_must_be_exactly_diagonal_and_W_must_be_final_water_owned_only_by_the_referenced_base_bay_or_its_wings",
		...
		bay_edge_transition_application="insert_the_selected_elbow_as_terminal_control_after_prefix_suffix_selection_and_before_the_existing_sole_final_edge_raster_then_run_all_ordinary_edge_validation_no_post_raster_append_or_snap",
		...
		bay_edge_transition_scalar_scope="E_W_and_the_derived_elbow_are_resolved_only_after_record_scalar_materialization_R16_never_enters_or_changes_extreme_scalar_record_identity_or_value_and_the_complete_4096_pool_and_selected_extreme_winners_are_generated_once_only_after_the_R16_source_freeze",
	...
	world_partition = {
		...
		bay_bank_nonwing_terminal_resolution="aperture_dry_is_the_adjacent_dry_station_on_the_declared_side_in_the_separate_authored_bank_terminal_order_land_edge_transition_is_the_once_resolved_direct_candidate_or_same_bay_diagonal_elbow_terminal_of_the_final_dry_edge_raster_no_inward_scan_or_private_shift_is_permitted",
