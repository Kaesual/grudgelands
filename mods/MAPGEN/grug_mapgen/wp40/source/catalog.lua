...
source.geometry_policies = {
	...
	boundary_displacement = {
		...
		shared_boundary_incidence_reject="missing_duplicate_or_mixed_obligation_zero_or_multiple_complete_intervals_or_transition_terminals_empty_nonunique_or_noncontiguous_control_subsequence_discarded_required_terminal_foreign_gap_or_excluded_fragment_missing_duplicate_or_land_edge_owned_rejects_without_fallback",
