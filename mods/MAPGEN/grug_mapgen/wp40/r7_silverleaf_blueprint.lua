-- Silverleaf Glade is authored in local coordinates around the elf start.
...
-- returns its Silverleaf composition, which carries the same bounds contract
...
return dofile(here .. "/r7_wp13_library.lua").composition("silverleaf")
