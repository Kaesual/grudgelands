-- Dawnmere Fields is authored in local coordinates around the human start.
...
-- returns its Dawnmere composition, which carries the same bounds contract
-- (x/z [-63, 63], y [-2, 24]), the same landmark keys and the same spawn,
-- gate and road geometry as Hearthpine, under its own schema string.
--
...
return dofile(here .. "/r7_wp13_library.lua").composition("dawnmere")
