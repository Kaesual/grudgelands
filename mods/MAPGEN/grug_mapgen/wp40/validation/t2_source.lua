...
local EXPECTED_POLICY_CHECKSUMS={
	...
	boundary_displacement="3e6209c76325fa7fa7395c7f75f15181f21ca2e81e8e8c26848019221d96e8fe",
...
local function validate_impl(source, vocabulary, canonical, raw_sha256)
	...
	if boundary_policy.input_rule~=
			...
			boundary_policy.shared_boundary_incidence_reject~=
				"missing_duplicate_or_mixed_obligation_zero_or_multiple_complete_intervals_or_transition_terminals_empty_nonunique_or_noncontiguous_control_subsequence_discarded_required_terminal_foreign_gap_or_excluded_fragment_missing_duplicate_or_land_edge_owned_rejects_without_fallback" or
			...
			boundary_policy.bay_edge_transition_terminal_selection~=
				"exactly_one_complete_joint_edge_tuple_across_the_full_finite_cartesian_set_is_required_and_selected_by_all_resolved_terminal_previous_and_probe_edge_byte_identities_two_distinct_tuples_with_the_same_identity_are_duplicate_authority_and_reject_zero_or_multiple_complete_tuples_reject_iteration_order_first_longest_nearest_scan_backstep_side_flip_and_private_tie_are_forbidden" or
			...
			boundary_policy.bay_edge_transition_terminal_reject~=
				"candidate_outside_interval_malformed_or_missing_adjacent_away_station_duplicate_resolved_tuple_identity_nonadjacent_or_missing_probe_anchor_edge_overlap_other_than_terminal_unreachable_incident_Bank_zero_or_multiple_complete_joint_tuples_changed_R7_scalar_identity_excluded_fragment_owner_failure_or_face_and_Whole_topology_failure_rejects_without_scan_snap_tail_connector_or_seed_fallback" or
