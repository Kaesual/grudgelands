...
local NEUTRAL = grug_core.NEUTRAL_HALF_WIDTH
...
local WEST_MAX = grug_core.REGION_WEST_MAX
local CENTER_MIN = grug_core.REGION_CENTER_MIN
local CENTER_MAX = grug_core.REGION_CENTER_MAX
local EAST_MIN = grug_core.REGION_EAST_MIN
...
-- Accord homeland: Elandor, the southern continent.
register_region({
	name = "grug_accord_hills", -- Dwarves: mountains/hills, pine forest
...
register_region({
	name = "grug_accord_plains", -- Humans: plains/meadows, capital region
	top = "default:dirt_with_grass",
	filler = "default:dirt",
...
register_region({
	name = "grug_accord_forest", -- Elves: deciduous forests
	top = "default:dirt_with_grass",
	filler = "default:dirt",
	filler_depth = 3,
...
-- Throng homeland: Kragmar, the northern continent.
register_region({
	name = "grug_throng_blight", -- Undead: barren dark forest/blight
	top = "default:dirt",
	filler = "default:dirt",
	filler_depth = 2,
...
register_region({
	name = "grug_throng_savanna", -- Orcs: savanna/badlands, capital region
...
register_region({
	name = "grug_throng_jungle", -- Trolls: jungle/swamp
