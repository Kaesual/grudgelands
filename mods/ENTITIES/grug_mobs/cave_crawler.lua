...
-- so the smaller budget still fills at the same rate. §4 prints 2200 for
-- this row as well: it is `underground`-only, and §4's header excludes every
-- cave-reaching row from the 0.75 surface-density multiplier (see
-- cave_bat.lua). WP37 must leave both cave rows alone.
--
