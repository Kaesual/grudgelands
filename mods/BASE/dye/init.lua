...
for _, row in ipairs(dye.dyes) do
	...
	-- GRUG PATCH: the per-colour "group:flower,color_X" recipe is removed -
	-- Grudgelands does not ship the `flowers` mod, so no node ever carries the
	-- `flower` group and the recipe could never be crafted.
end
