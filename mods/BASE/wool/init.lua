...
-- GRUG PATCH: fresh-server mode - the two jordach 16-color aliases
-- ("wool:dark_blue", "wool:gold") were old-name readers for worlds built with
-- another wool mod and are removed. No saved world can contain them.
