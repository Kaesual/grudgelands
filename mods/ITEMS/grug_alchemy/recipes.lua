...
local catalog = {
	...
	potion("potion_mana", "Mana Potion", 1, G .. "gravemoss",
		G .. "sugar_cane", "mana", grug_alchemy.POTION_COOLDOWN, "#356ed1"),
	...
	potion("potion_greater_mana", "Greater Mana Potion", 3,
		G .. "crimson_lotus", G .. "sugar_cane", "mana",
		grug_alchemy.GREATER_COOLDOWN, "#253ea3"),
	utility("potion_cave", "Cave Draught", 3, G .. "cave_cap",
	...
	elixir("elixir_focus_t3", "Elixir of Focus III", 3,
		G .. "crimson_lotus", G .. "cave_cap", "mana_pool_percent", 5,
