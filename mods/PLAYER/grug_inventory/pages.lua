...
sfinv.register_page("grug_inventory:help", {
	...
	get = function(self, player, context)
		local text = table.concat({
			...
			"The Character pool lines read maximum = B x C x (100 + G + T)%, where B is the base pool, C the class factor, G the gear percentage and T the talent percentage. Active food or elixir statuses add their pool percentage on top of G and T.",
