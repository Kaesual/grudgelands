...
grug_mounts.MODELS = {
	...
	dwarf = {
		...
		icon = "grug_mobs_ibex.png^[multiply:#d8c49d",
	...
	orc = {
		...
		icon = "grug_mobs_boar.png^[multiply:#9a6047",
	...
	undead = {
		...
		icon = "grug_mobs_wolf_blightfang.png^[multiply:#b3a6ca",
	...
	troll = {
		...
		icon = "grug_mounts_tiger.png^[multiply:#d69a52",
		visual_size = {x = 1.45, y = 1.45},
	...
	expert_accord = {
		...
		icon = "grug_mobs_eagle.png^[multiply:#9eb9dc",
		visual_size = {x = 3, y = 3},
	...
	master_accord = {
		...
		icon = "grug_mobs_eagle.png^[multiply:#eee3b6",
		visual_size = {x = 4, y = 4},
	...
	expert_throng = {
		...
		icon = "grug_mobs_cave_bat.png^[multiply:#856f8e",
		visual_size = {x = 3, y = 3},
	...
	master_throng = {
		...
		icon = "grug_mobs_cave_bat.png^[multiply:#7d3549",
